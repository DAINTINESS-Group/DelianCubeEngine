...
public class AnalyzeOperatorByIakovidis implements IntentionalOperator {
	...
	public AnalyzeOperatorByIakovidis(CubeManager cubeManager, AnalyzeTranslationManager analyzeTranslationManager) {

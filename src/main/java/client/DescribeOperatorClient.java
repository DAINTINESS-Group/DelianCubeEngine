...
public class DescribeOperatorClient {
	...
	public static void main(String[] args) throws Exception{
		...
		String describeExpression = "WITH loan DESCRIBE (SUM(amount) - SUM(payments)) AS Test FOR region IN {'Prague', 'north Bohemia'} AND year >= '1997' GROUP BY district_name, month USING KPIMedianBased, EquiDepth, ZScoreBased";

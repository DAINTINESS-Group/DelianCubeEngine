...
public class Pkdd99Experiments {
	...
	private static final String[] QUERIES = {
		...
		"CubeName:loan\nName:Q5\nAggrFunc:Sum\nMeasure:amount\n"
			+ "Gamma:account_dim.lvl1\nSigma:date_dim.lvl2='1997-01'",
		"CubeName:loan\nName:Q6\nAggrFunc:Sum\nMeasure:amount\n"
			+ "Gamma:account_dim.lvl1\nSigma:date_dim.lvl3='1998'",
		"CubeName:loan\nName:Q7\nAggrFunc:Sum\nMeasure:amount\n"
			+ "Gamma:account_dim.lvl1\nSigma:date_dim.lvl3='1997'",
		"CubeName:loan\nName:Q8\nAggrFunc:Sum\nMeasure:amount\n"
	...
	public static void main(String[] args) throws Exception {
		...
		try (PrintWriter writer = new PrintWriter(new FileWriter("selectivity_results_pkdd99.txt"))) {

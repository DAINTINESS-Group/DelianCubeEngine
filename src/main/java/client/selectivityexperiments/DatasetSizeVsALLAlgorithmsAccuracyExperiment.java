...
/**
 * Experiment 6 : the accuracy (effectiveness) of every estimation algorithm.
 * The Full Table Scan is the ground truth. For every query the estimated selectivity is compared against it, and the RMSE
 * over the ten queries is the metric. Takes the dataset as its only argument and writes OutputFiles/experiment6_{dataset}.txt.
...
public class DatasetSizeVsALLAlgorithmsAccuracyExperiment {
	...
	public static void main(String[] args) throws Exception {
		if(args.length < 1) {
			System.err.println("Usage : DatasetSizeVsALLAlgorithmsAccuracyExperiment tpc_ds_2M | tpc_ds_10M | tpc_ds_100M");
			return;
		}

...
public class SigmaParser {
	...
	public static class ParsedSigma {
		public final String filterCol;
		public final String dimTable;
		public final String factFK;
		public final String dimPK;
	 ...
	 */
	public static ParsedSigma parse(String[] sigma, List<Dimension> dimensions, List<String> dimRefFields) {

package decisiontree.generator;

import decisiontree.datapreparation.DecisionTreeDataProcessor;
import decisiontree.datapreparation.AttributesFinder;
import decisiontree.datapreparation.DecisionTreePathsFinder;
import decisiontree.DecisionTree;
import decisiontree.node.DecisionTreeNode;
import decisiontree.node.DecisionTreeNodeParams;
...
public class DecisionTreeGenerator implements IDecisionTreeGenerator {
    ...
    private void trainDecisionTreeModel() {
        ...
        System.out.println(model.toDebugString()); //gia print to dentro
    }

...
public class AnalyzeOperatorMidMQO implements IntentionalOperator {
	...
	public AnalyzeOperatorMidMQO(CubeManager cubeManager,AnalyzeTranslationManager analyzeTranslationManager) {

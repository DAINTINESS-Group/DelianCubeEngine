...
public class AnalyzeOperatorMinMQO implements IntentionalOperator {
	...
	public AnalyzeOperatorMinMQO(CubeManager cubeManager, AnalyzeTranslationManager analyzeTranslationManager) {

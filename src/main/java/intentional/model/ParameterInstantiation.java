...
/**
 * The value a {@link ModelResult} bound to one of its model's {@link ParameterRole}s: an arithmetic value,
 * or, for an enumerated parameter, the ordinal of the chosen constant plus its name.
 */

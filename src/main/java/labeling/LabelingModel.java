 ...
 * the {@link DerivedMeasure}s it computed on the way. An operator's {@code OperatorResult} holds these and
...
public interface LabelingModel {
    ...
    /** Identifies this model's output within an {@code OperatorResult}. */
    String getModelName();

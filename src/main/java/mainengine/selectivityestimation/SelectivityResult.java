 ...
 */
public class SelectivityResult {
	...
	public SelectivityResult(String[] sigmaExpression, String tableName, String columnName, int totalRows,
			int matchingRows) {
	...
	public String toString() {
		return String.format(
				...
				sigmaExpression[0], sigmaExpression[1], sigmaExpression[2], tableName, columnName, matchingRows,
				totalRows, selectivity);
	}
}